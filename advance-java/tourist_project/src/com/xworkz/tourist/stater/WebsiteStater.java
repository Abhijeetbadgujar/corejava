...
//		dao.save(new WebsiteEntity(  "amazon", "www.amazon", 2000, "andy jassy", ".com"));
//		
		//WebsiteEntity entity2=new WebsiteEntity( "capgemini", "www", 1947, "abhi", ".com");
		//WebsiteEntity entity2=new WebsiteEntity( "Mit", "www", 1947, "abhi", ".com");

		//dao.save(entity2);
		//WebsiteEntity websiteEntity=dao.getByNameflipkart();
		//System.out.println(websiteEntity);
		
		WebsiteEntity entity=dao.getgetByLikeUrlX();
