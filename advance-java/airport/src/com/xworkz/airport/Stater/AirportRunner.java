...
public class AirportRunner {
	...
	public static void main(String[] args) {
		...
		AirportEntity airportEntity=new AirportEntity( "CSMT","123455","metropolitan","mumbai","maharashtra",540,440,980,2,true,true,78,940,1000,"Abhijeet",LocalDateTime.now(),"vandana",LocalDateTime.now());
