...
public class iteratorCollection {
	...
	System.out.println("collection is empty or not:"+collection2.isEmpty());	
	System.out.println("Collection size:"+collection2.size());

	System.out.println("remove some actoress:"+collection2.remove("Aishwarya"));
	System.out.println("after remove than size:"+collection2.size());
	collection2.clear();
	System.out.println("clear size:"+collection2.size());
	System.out.println("----------------------------------");
	...
	System.out.println("collection is empty or not:"+collection3.isEmpty());	
	System.out.println("remove some language:"+collection3.remove("sindu"));
	System.out.println("after remove language:"+collection3.size());
	System.out.println("----------------------------------");
	...
	Iterator<String> iterator2=collection4.iterator();
	
	while(iterator2.hasNext()) {
		System.out.println("movies:"+iterator2.next());
	}
	System.out.println("size of collection"+collection4.size());
	System.out.println("collection is empty or not:"+collection4.isEmpty());
	System.out.println("remove some movies:"+collection4.remove("comrade"));
	System.out.println("after remove movies:"+collection4.size());
	System.out.println("--------------------------------------");
	...
	Iterator<String> iterator3= collection5.iterator();
	
	while(iterator3.hasNext()) {
		System.out.println(iterator3.next());
	}
	System.out.println("total size:"+collection5.size());
	System.out.println("collection is empty or not:"+collection5.isEmpty());
	System.out.println("remove some web series:"+collection5.remove("Streger things"));
	System.out.println("after remove:"+collection5.size());
	System.out.println("---------------------------------");
	...
	Iterator<String> iterator4=collection6.iterator();
	
	while(iterator4.hasNext()){
		System.out.println(iterator4.next());
	}
	System.out.println("total size:"+collection6.size());
	System.out.println("collection is empty or not:"+collection6.isEmpty());
	System.out.println("remove some city name:"+collection6.remove("mandya"));
	System.out.println("after remove:"+collection6.size());
	System.out.println("------------------------------");
	...
	collection7.add("fafadda");
	
	Iterator<String> iterator5=collection7.iterator();
	...
	System.out.println(collection7.remove("fafadda"));
	System.out.println(collection7.size());
	System.out.println("-------------------------------");
	...
	Iterator<String> iterator6=collection8.iterator();
	
	while(iterator6.hasNext()) {
		System.out.println(iterator6.next());
	}
	System.out.println(collection8.size());
	System.out.println(collection8.isEmpty());
	System.out.println(collection8.remove("pulsar 150"));
	System.out.println(collection8.size());
	System.out.println("-------------------------------");
	...
	Iterator<String> iterator7=collection9.iterator();
	
	while(iterator7.hasNext()) {
		System.out.println(iterator7.next());
	}
	System.out.println(collection9.size());
	System.out.println(collection9.isEmpty());
	System.out.println(collection9.remove("Volvo S60 T5 Sedan 2018"));
	System.out.println(collection9.size());
	System.out.println("-------------------------------");
	...
	Iterator<String> iterator8=collection10.iterator();
	
	while(iterator8.hasNext()) {
		System.out.println(iterator8.next());
	}
	System.out.println(collection10.size());
	System.out.println(collection10.isEmpty());
	System.out.println(collection10.remove("red"));
	System.out.println(collection10.size());
	System.out.println("-------------------------------");
	...
	Iterator<String> iterato=collection.iterator();
	...
	System.out.println(collection.remove("dol"));
	System.out.println(collection.size());
	System.out.println("-------------------------------");
